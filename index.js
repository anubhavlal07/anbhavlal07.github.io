 ...
 const messages = [
    ...
    ['It appears', 'Looks like', 'Unfortunately,', 'It just so happens that ', 'Sadly,', 'Seemingly from nowhere'],
    ['there was an error.', 'I goofed up.', 'a bad thing happend.', 'the code crashed.', 'a bug appeared.', 'someone did a naughty.', 'the code threw a tantrum.', 'the website had a bad day.', 'my code pooped out.'],
    ['Sorry.', 'Apologies.', 'My bad.', 'Sad day.', 'I am quite contrite.', 'Beg pardon.']
 ];
