        ...
        articles.forEach(function (element, index) {
            let news = `<div class="accordion-item">
                            ...
                            <div id="flush-collapse${index}" class="accordion-collapse collapse" aria-labelledby="flush-heading${index}"
                                ...
                                <div class="accordion-body">${element.description} — ${element.author} <br> <a href="${element.url}" target="_blank"> Read Full Article </a></div>
                            </div>
                        </div>`;
            newsHtml += news;
        });
...
document.addEventListener('keydown', function () {
    if (event.keyCode == 123) {
        alert("This function has been disabled to prevent you from viewing my code!");
        return false;
